...
import com.a0x03.wythe.easytransport.Adapter.MyRecyclerViewAdapter;
import com.a0x03.wythe.easytransport.Adapter.MyStaggeredViewAdapter;
...
public class MyFragment extends Fragment
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    mRecyclerView = (RecyclerView) mView.findViewById(R.id.recy_indent_list);

    flag = (int) getArguments().get("flag");
    configRecyclerView();

    // 刷新时，指示器旋转后变化的颜色
    mSwipeRefreshLayout.setColorSchemeResources(R.color.accent, R.color.btn_auth_accept_text_color);
